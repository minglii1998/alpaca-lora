...
parser.add_argument('--trained_check_path', default="lora-cot/checkpoint-5400", type=str)
...
parser.add_argument('--record_special_tag', default="lora-cot", type=str)
...
if args.model_type == "llama":
    ...
    # LORA_WEIGHTS = "./saved-checkpoints/saved-"+args.data+args.size+"b"
...
if device == "cuda":
    if args.model_type == "llama":
        ...
        checkpoint_name = os.path.join(args.trained_check_path, "pytorch_model.bin")
